...
public class Menu extends JPanel {
    ...
    public Menu() {
        ...
        boton3.addActionListener((ActionEvent e) -> {
            ...
            creditos.setBounds(0, 0, getWidth(), getHeight()); // Corregido para consistencia
            add(creditos);
        ...
        // Iniciar música una vez en el constructor
        iniciarMusica("/assets/CancionFondo.wav");
    }
    ...
    public void paint(Graphics g) {
        ...
        // Removido: iniciarMusica aquí, ya que se llama en el constructor
    }
    ...
    public void iniciarMusica(String ruta) {
        try {
            InputStream audioSrc = getClass().getResourceAsStream("/assets/CancionFondo.wav"); // Corregido para usar "/assets/"
