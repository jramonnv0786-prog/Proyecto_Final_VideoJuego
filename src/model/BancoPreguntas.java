...
public class BancoPreguntas {
    ...
    public static List<Pregunta> getPreguntasEntornos() {
        return new ArrayList<>(List.of(
                new Pregunta("¿Qué significa IDE?", "Entorno de Desarrollo Integrado", "Interfaz de Datos Electrónicos",
                        "Motor de Base de Datos Interna", "Editor de Diseño Interactivo", 1),
                new Pregunta("¿Cuál es un ejemplo de IDE popular?", "Microsoft Word", "Eclipse", "Photoshop", "Excel",
                        2),
                new Pregunta("¿Qué es Git?", "Un lenguaje de programación", "Un sistema de control de versiones",
                        "Un IDE", "Un compilador", 2),
                new Pregunta("¿Qué comando de Git se usa para subir cambios al repositorio remoto?", "git pull",
                        "git push", "git commit", "git add", 2),
                new Pregunta("¿Qué es un framework?", "Un tipo de hardware",
                        "Un conjunto de herramientas y bibliotecas para desarrollar software", "Un sistema operativo",
                        "Un navegador web", 2),
                new Pregunta("¿Cuál es un ejemplo de framework para Java?", "React", "Spring", "Django", "Laravel", 2),
                new Pregunta("¿Qué es el testing unitario?", "Probar el software completo",
                        "Probar componentes individuales del código", "Probar la interfaz de usuario",
                        "Probar la base de datos", 2),
                new Pregunta("¿Qué herramienta se usa comúnmente para testing en Java?", "JUnit", "Selenium", "Postman",
                        "Jenkins", 1),
                new Pregunta("¿Qué es Maven?", "Un IDE", "Una herramienta de gestión de proyectos y dependencias",
                        "Un lenguaje de programación", "Un servidor web", 2),
                new Pregunta("¿Qué archivo configura las dependencias en Maven?", "pom.xml", "build.gradle",
                        "package.json", "requirements.txt", 1),
                new Pregunta("¿Qué es Scrum?", "Un lenguaje de programación", "Una metodología ágil", "Un IDE",
                        "Un framework", 2),
                new Pregunta("¿Cuál es el rol del Scrum Master?", "Desarrollar el código", "Facilitar el proceso Scrum",
                        "Diseñar la interfaz", "Gestionar la base de datos", 2),
                new Pregunta("¿Qué es la integración continua?", "Un tipo de base de datos",
                        "La práctica de integrar cambios de código frecuentemente", "Un lenguaje de scripting",
                        "Un servidor de aplicaciones", 2),
                new Pregunta("¿Qué herramienta se usa para integración continua?", "Git", "Jenkins", "Eclipse", "Maven",
                        2),
    ...
    public static List<Pregunta> getPreguntasDigitalizacion() {
        return new ArrayList<>(List.of(
                new Pregunta("¿Qué es la transformación digital?", "Pasar todos los archivos a PDF",
                        "Integrar tecnología en todas las áreas de una empresa", "Comprar ordenadores nuevos",
                ...
                new Pregunta("¿A qué hace referencia el término 'Cloud Computing' (Computación en la nube)?",
                        "Almacenamiento y servicios a través de internet", "Predicción del clima mediante software",
                        "Redes sociales en la estratosfera", "Ordenadores que funcionan con energía solar", 1),
                new Pregunta("¿Qué significa 'IoT' (Internet de las Cosas)?", "Internet Of Technology",
                        "Internal Organization Tools", "Interconexión digital de objetos cotidianos con internet",
                ...
                new Pregunta("¿Qué es el 'Big Data'?", "Un disco duro de gran tamaño",
                        ...
                        "Una empresa de telecomunicaciones", "El servidor principal de internet", 2),
                new Pregunta(
                ...
                new Pregunta("¿Qué es el comercio electrónico (E-commerce)?", "Enviar correos electrónicos comerciales",
                ...
                new Pregunta("¿Qué significa SEO en marketing digital?", "Search Engine Optimization",
                        "System Electronic Output", "Secure Enterprise Operations", "Software Execution Order", 1),
                new Pregunta("¿A qué se refiere el término 'Brecha Digital'?",
                        "Un virus que rompe el sistema operativo", "Desigualdad en el acceso y uso de las TIC",
                ...
                new Pregunta("¿Qué tecnología permite a una máquina simular inteligencia humana?",
                        "Realidad Virtual (VR)", "Inteligencia Artificial (IA)", "Internet de las Cosas (IoT)",
                ...
                new Pregunta("La Cuarta Revolución Industrial (Industria 4.0) se caracteriza principalmente por...",
                        ...
                        "Sistemas ciberfísicos, IoT e IA en la industria", "Invención de la bombilla", 3),
                new Pregunta("¿Cuál es una ventaja clave del teletrabajo (trabajo remoto)?",
                        "Exige comprar equipo más caro", "Flexibilidad geográfica y de horarios",
                        "Reduce los sueldos a la mitad", "Elimina la necesidad de usar internet", 2),
                new Pregunta(
                        "¿Qué tecnología mezcla entornos reales con objetos virtuales superpuestos en tiempo real?",
                        "Realidad Virtual (VR)", "Realidad Aumentada (AR)", "Metaverso", "Cloud Computing", 2)));
    }

    public static List<Pregunta> getPreguntasLenguajeDeMarca() {
        return new ArrayList<>(List.of(
                new Pregunta("¿Qué significa HTML?", "Hyper Terminal Markup Language", "HyperText Markup Language",
                        "High Transfer Machine Language", "Hyperlink Text Management Language", 2),
                new Pregunta("¿Cuál de las siguientes etiquetas define el título de un documento HTML?", "<head>",
                        "<meta>", "<title>", "<h1>", 3),
                new Pregunta("¿Qué lenguaje se usa principalmente para dar estilo a las páginas web?", "HTML",
                ...
                new Pregunta("¿Cuál es la etiqueta correcta para insertar una imagen en HTML?", "<image src='img.jpg'>",
                        "<img href='img.jpg'>", "<img src='img.jpg'>", "<pic src='img.jpg'>", 3),
                new Pregunta("¿Qué etiqueta se utiliza para crear un enlace (hipervínculo) en HTML?", "<link>", "<a>",
                        "<href>", "<url>", 2),
                new Pregunta("En HTML5, ¿cuál etiqueta se usa para reproducir contenido de video?", "<media>",
                        "<movie>", "<video>", "<mp4>", 3),
                new Pregunta("¿Qué significa JSON?", "Java Standard Output Network", "JavaScript Object Notation",
                        "JavaScript Oriented Network", "Java Serialized Object Node", 2),
                new Pregunta("¿Cuál es la estructura básica de una tabla en HTML?", "<table>, <tr>, <td>",
                        "<table>, <row>, <cell>", "<tab>, <tr>, <td>", "<table>, <head>, <body>", 1),
                new Pregunta("¿Qué atributo HTML se usa para definir estilos en línea (inline)?", "class", "font",
                        "style", "styles", 3),
                new Pregunta("¿Cuál de estos NO es un lenguaje de marcado?", "HTML", "XML", "Markdown", "Python", 4),
                new Pregunta("¿Qué etiqueta de HTML5 se usa para el contenido principal de un documento?", "<main>",
                        "<content>", "<section>", "<body>", 1),
                new Pregunta("¿Qué lenguaje se usa comúnmente para escribir archivos de configuración simples?", "YAML",
                        "C++", "Java", "PHP", 1),
                new Pregunta("¿Qué versión de HTML introdujo elementos semánticos como <article> y <nav>?", "HTML 3.2",
    ...
    public static List<Pregunta> getPreguntasProgramacion() {
        return new ArrayList<>(List.of(
                ...
                new Pregunta("¿Cuál es el propósito principal de la sentencia 'if' en programming?", "Repetir código",
                        "Realizar cálculos matemáticos", "Tomar decisiones condicionales", "Declarar variables", 3),
                ...
                new Pregunta("¿Qué significa 'HTML' en el contexto del desarrollo web?",
                        ...
                        "Hyperlink and Text Management Language", "Home Tool Markup Language", 2),
                new Pregunta("¿Cuál es el resultado de la siguiente operación: 5 + 3 * 2?", "16", "11", "13", "8", 2),
                new Pregunta("¿Qué tipo de dato se utiliza para representar valores verdadero o falso?", "String",
                        "Integer", "Boolean", "Float", 3),
                new Pregunta(
                        "¿Qué se utiliza para comentar una sola línea en la mayoría de los lenguajes de programación?",
                        "//", "/* */", "#", "<!-- -->", 1),
                new Pregunta("¿Qué significa 'API' en el contexto de software?", "Advanced Programming Interface",
                ...
                new Pregunta("¿Qué significa el acrónimo POO (o OOP en inglés)?", "Programación Orientada a Objetos",
                        "Programación Oficial de Ordenadores", "Programa Organizado en Operaciones",
                ...
                new Pregunta("¿Qué es un 'bug' en el contexto de la programación?",
                        "Una nueva característica del programa", "Un error o fallo en el código",
                        "Un tipo de algoritmo de ordenación", "Una herramienta de diseño de interfaces", 2),
                new Pregunta(
